...
function mensagem(resp) {
  if (resp == "ok"){
     Swal.fire({
      title: "Ótimo!!!",
      text: "Veículo desabilitado com sucesso!\n ",
      icon: "success",
      button: "Ok!",
      });
    return false;
  ...
  Swal.fire({
      title: "Ops!!!",
      text: "Ocorreu um erro ao desativar o veículo!",
      icon: "error",
      button: "Ok!",
      });
    return false;
    ...
    <div class="table-responsive p-3">
      ...
      <%
        ...
        <tr>
            ...
            <td ><%=ObjRst("Placa")%></td>       
            <td>
            <a href="crud_veiculo.asp?id=<%=ObjRst("Id")%>&operacao=2" class="btn btn-danger btn-sm" alt="Desativar veículo">
